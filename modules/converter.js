...
const steam64id = "76561198116173009";

const SteamIDConverter = {
...
console.log(SteamIDConverter.toSteamID(steam64id));
console.log(SteamIDConverter.toSteamID3(steam64id));